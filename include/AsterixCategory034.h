 ...
 * @section DESCRIPTION
 *
 * Class for encoding and decoding Asterix messages of CAT 034.
 */

#ifndef ASTERIXCATEGORY034_H_
#define ASTERIXCATEGORY034_H_

#include "AsterixCategory.h"

class AsterixCategory034: public AsterixCategory {
private:
...
public:
   AsterixCategory034();
   AsterixCategory034( int length );
   AsterixCategory034( int length, std::deque<char>& m_queue );
   virtual ~AsterixCategory034();
