 ...
 * @section DESCRIPTION
 *
 * Class representing an Asterix CAT 204 (Recognised Air Picture) message
 */

#ifndef ASTERIXCATEGORY204_H_
#define ASTERIXCATEGORY204_H_

#include "AsterixCategory.h"

class AsterixCategory204: public AsterixCategory {
private:
...
public:
   ...
   AsterixCategory204();
   AsterixCategory204( int length );
   AsterixCategory204( int length, std::deque<char>& m_queue );
   virtual ~AsterixCategory204();
