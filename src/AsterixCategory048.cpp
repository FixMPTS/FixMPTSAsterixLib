...
void AsterixCategory048::setSubitems() {
   ...
   radar_characteristics.push_back( subitem_t( Cat048ItemNames::I048_130_SRLL, // SSR Plot Runlength
      std::make_shared<AsterixSubitemUnsigned>( 8, UnsignedDoubleConverter::Direction13Bit::get() ) ) );
   ...
   radar_characteristics.push_back( subitem_t( Cat048ItemNames::I048_130_RPD, // Difference in Range between PSR and SSR Plot
      std::make_shared<AsterixSubitemUnsigned>( 8, DoubleConverter::Fraction256th::get() ) ) );
   radar_characteristics.push_back( subitem_t( Cat048ItemNames::I048_130_APD, // Difference in Amplitude between PSR and SSR Plot
      std::make_shared<AsterixSubitemUnsigned>( 8, UnsignedDoubleConverter::Fraction360th::get() ) ) );
   ...
   mode_c_code.push_back(
      subitem_t( Cat048ItemNames::I048_100_CODE,
         std::make_shared<AsterixSubitemUnsigned>( 14, IntegerConverter::LBitsToQuarter::get() ) ) );
   ...
   doppler_speed.push_back(
      subitem_t( Cat048ItemNames::I048_120_RDS,
         std::make_shared<AsterixSubItemRep>( 48, CommonConverter::NoneConverterBuffer::get(),
            sub_sub_item_120_l ) ) );
   ...
   sub_sub_item_re_pos.push_back(
      subitem_t( Cat048ItemNames::I048_RE_LAT,
         std::make_shared<AsterixSubitemUnsigned>( 25, DoubleConverter::WGS84resolution23Bit::get() ) ) );
   ...
   sub_sub_item_re_pos.push_back(
      subitem_t( Cat048ItemNames::I048_RE_GA,
         std::make_shared<AsterixSubitemUnsigned>( 24, IntegerConverter::LBitsToQuarter::get() ) ) );
   ...
   sub_sub_item_re_xp.push_back(
      subitem_t( Cat048ItemNames::I048_RE_X1,
         std::make_shared<AsterixSubitemUnsigned>( 1, UnsignedDoubleConverter::Fraction128th::get() ) ) );
   sub_sub_item_re_xp.push_back(
   ...
   reserved_expansion_field.push_back(
      subitem_t( Cat048ItemNames::I048_RE_MD5_SUM,
         std::make_shared<AsterixSubitemCompound>( -1, CommonConverter::NoneConverterBuffer::get(),
            sub_sub_item_re_md5 ) ) );
   reserved_expansion_field.push_back(
