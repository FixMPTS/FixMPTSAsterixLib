...
void AsterixCategory062::setSubitems() {
   ...
   subitems.insert( subitem_map_item_t( 6, calc_track_vel_cartesian ) );
   subitems.insert( subitem_map_item_t( 7, calculated_acceleration ) );
   subitems.insert( subitem_map_item_t( 8, track_m3a ) );
   subitems.insert( subitem_map_item_t( 9, target_id ) );
   subitems.insert( subitem_map_item_t( 10, aircraft_derived_data ) );
   subitems.insert( subitem_map_item_t( 11, track_number ) );
   subitems.insert( subitem_map_item_t( 12, track_status ) );
   subitems.insert( subitem_map_item_t( 13, track_update_ages ) );
   subitems.insert( subitem_map_item_t( 14, mode_of_movement ) );
   subitems.insert( subitem_map_item_t( 15, track_data_ages ) );
   subitems.insert( subitem_map_item_t( 16, meas_flighht_level ) );
   subitems.insert( subitem_map_item_t( 17, calculated_geo_alt ) );
   subitems.insert( subitem_map_item_t( 18, calculated_baro_alt ) );
   subitems.insert( subitem_map_item_t( 19, calc_rate_cb ) );
   subitems.insert( subitem_map_item_t( 20, flight_plan_data ) );
   subitems.insert( subitem_map_item_t( 21, size_orientation ) );
   subitems.insert( subitem_map_item_t( 22, vehicle_fleet ) );
   subitems.insert( subitem_map_item_t( 23, mode_5 ) );
   subitems.insert( subitem_map_item_t( 24, mode_2 ) );
   subitems.insert( subitem_map_item_t( 25, composed_track_nr ) );
   subitems.insert( subitem_map_item_t( 26, estimated_acc ) );
   subitems.insert( subitem_map_item_t( 27, measured_info ) );
}
