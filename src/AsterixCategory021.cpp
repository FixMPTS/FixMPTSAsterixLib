...
void AsterixCategory021::setSubitems() {
   ...
   pos_wgs_high.push_back(
      subitem_t( Cat021ItemNames::I021_131_LAT,
         std::make_shared<AsterixSubitemUnsigned>( 32, DoubleConverter::WGS84resolution30Bit::get() ) ) );
   pos_wgs_high.push_back(
   ...
   time_of_recept_position.push_back(
      subitem_t( Cat021ItemNames::I021_073_TIME,
         std::make_shared<AsterixSubitemUnsigned>( 24, UnsignedDoubleConverter::Fraction30Bit::get() ) ) );
   ...
   time_of_recept_position_h.push_back(
      subitem_t( Cat021ItemNames::I021_074_TIME,
         std::make_shared<AsterixSubitemUnsigned>( 30, UnsignedDoubleConverter::Fraction30Bit::get() ) ) );
   ...
   geometric_height.push_back(
      subitem_t( Cat021ItemNames::I021_140_GH,
         std::make_shared<AsterixSubitemUnsigned>( 24, DoubleConverter::GeoAltitudeFt::get() ) ) );
   ...
   roll_angle.push_back(
      subitem_t( Cat021ItemNames::I021_230_RA,
         std::make_shared<AsterixSubitemUnsigned>( 16, UnsignedDoubleConverter::Fraction100th::get() ) ) );

   subitem_map_t flight_level;
   flight_level.push_back(
      subitem_t( Cat021ItemNames::I021_145_FL,
         std::make_shared<AsterixSubitemUnsigned>( 16, IntegerConverter::LBitsToQuarter::get() ) ) );
   ...
   barp_vertical_rate.push_back(
      subitem_t( Cat021ItemNames::I021_155_RATE,
         std::make_shared<AsterixSubitemUnsigned>( 15, DoubleConverter::VerticalRate::get() ) ) );
   ...
   airborn_ground_vector.push_back(
      subitem_t( Cat021ItemNames::I021_160_GSP,
         std::make_shared<AsterixSubitemUnsigned>( 15, UnsignedDoubleConverter::SpeedNMToKt::get() ) ) );
   airborn_ground_vector.push_back(
   ...
   track_angle_rate.push_back(
      subitem_t( Cat021ItemNames::I021_165_TAR,
         std::make_shared<AsterixSubitemUnsigned>( 10, UnsignedDoubleConverter::Fraction32nd::get() ) ) );
   ...
   target_identification.push_back(
      subitem_t( Cat021ItemNames::I021_170_ID,
         std::make_shared<AsterixSubitemUnsigned>( 48, CommonConverter::NoneConverter::get() ) ) );
   ...
   selected_altitude.push_back(
      subitem_t( Cat021ItemNames::I021_146_ALT,
         std::make_shared<AsterixSubitemUnsigned>( 13, IntegerConverter::Alt25ft::get() ) ) );
   ...
   sub_sub_item_110_tid.push_back(
      subitem_t( Cat021ItemNames::I021_110_TID_ALT,
         std::make_shared<AsterixSubitemUnsigned>( 16, UnsignedDoubleConverter::Fact10::get() ) ) );
   sub_sub_item_110_tid.push_back(
   ...
   trajectory_intent.push_back(
      subitem_t( Cat021ItemNames::I021_110_TID,
         std::make_shared<AsterixSubItemRep>( 120, CommonConverter::NoneConverterBuffer::get(),
            sub_sub_item_110_tid ) ) );

   subitem_map_t service_management;
   service_management.push_back(
      subitem_t( Cat021ItemNames::I021_016_RP,
         std::make_shared<AsterixSubitemUnsigned>( 8, DoubleConverter::FractionHalf::get() ) ) );
   ...
   acas_resolution.push_back(
      subitem_t( Cat021ItemNames::I021_260_TID,
         std::make_shared<AsterixSubitemUnsigned>( 26, CommonConverter::NoneConverter::get() ) ) );
   ...
   sub_re_selh.push_back(
      subitem_t( Cat021ItemNames::I021_RE_SELH_VAL,
         std::make_shared<AsterixSubitemUnsigned>( 10, UnsignedDoubleConverter::SelectedHeading::get() ) ) );
   ...
   sub_re_sgv.push_back(
      subitem_t( Cat021ItemNames::I021_RE_SGV_GSS,
         std::make_shared<AsterixSubitemUnsigned>( 11, UnsignedDoubleConverter::SpeedVelToKt::get() ) ) );
   sub_re_sgv.push_back(
      subitem_t( Cat021ItemNames::I021_RE_SGV_HGT,
         std::make_shared<AsterixSubitemUnsigned>( 7, UnsignedDoubleConverter::GroundTrackHeading::get() ) ) );
   ...
   reserved_expansion_field.push_back(
      subitem_t( Cat021ItemNames::I021_RE_MES,
         std::make_shared<AsterixSubitemCompound>( 88, CommonConverter::NoneConverterBuffer::get(),
            sub_re_mes ) ) );
